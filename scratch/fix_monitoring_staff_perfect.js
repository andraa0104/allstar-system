...
// find the end of the widget which is right before export default function ProductionPipelinePage
const widgetEnd = orderControlCode.indexOf('export default function ProductionPipelinePage');
...
console.log('Done perfectly rewriting monitoring-staff!');
