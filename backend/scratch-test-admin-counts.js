...
async function main() {
  ...
  const [outRows] = await connection.execute(
    ...
    { completedStatus, packingReadyStatus, search, searchPattern }
  );
  console.log("Admin Outstanding Count:", outRows[0].total);
  ...
  console.log("Admin Deadline Count:", dlRows[0].total);
  ...
  console.log("Admin Overdue Count:", odRows[0].total);
