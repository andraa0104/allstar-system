...
export default function ProductionPipelinePage() {
  ...
  // Check live access for "Order Control" V permission
  const hasAccess = (() => {
    ...
    return !!userPerms.permissions["Order Control"]?.V;
  })();
    ...
    return (
      <div className="flex flex-col items-center justify-center p-24 text-center border border-dashed border-slate-800 rounded-xl bg-slate-900/10 backdrop-blur-md max-w-2xl mx-auto my-12 shadow-xl shadow-slate-950/20">
        ...
        <p className="text-xs text-slate-400 max-w-sm leading-relaxed">
          Anda tidak memiliki hak akses (View Privilege) untuk menu **Order Control**. Hubungi administrator utama Anda untuk meminta izin otorisasi.
        </p>
      </div>
    );
  }
  ...
  return (
    <>
      <PageHeader
        title="Order Control"
        description="Kelola alur FO dari outstanding, deadline, sampai complete dalam sub menu order control."
      />
